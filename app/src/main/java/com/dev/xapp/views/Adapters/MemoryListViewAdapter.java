                ...
                try {
                    new AsyncTask<Void, Integer, Void>(){
                        ...
                        protected void onPostExecute(Void unused) {
                            ...
                            MemoryFragment.memoryListViewAdapter.clear();
                            File[] files = MemoryFragment.currentFolder.listFiles();
                            for(File file: files)
                                if(file.isDirectory()){
                                    long size = Folders.getFolderSize(file);
                                    MemoryFragment.memoryListViewAdapter.add(new Folders(R.drawable.ic_folders, file, size));
                                }
                                else{
                                    long size = Folders.getFolderSize(file);
                                    MemoryFragment.memoryListViewAdapter.add(new Folders(R.drawable.ic_file, file, size));
                                }
