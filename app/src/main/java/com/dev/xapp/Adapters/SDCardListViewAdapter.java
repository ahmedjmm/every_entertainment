...
import static com.dev.xapp.fragments.storageFragments.SDCardFragment.sdCardListViewAdapter;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                sdCardListViewAdapter.notifyDataSetChanged();
                actionMode.setTitle(checkStates.size() + " selected");
            }
        });
            ...
            case R.id.rename:
                ...
                alertDialog.setPositiveButton(R.string.ok_alert_dialog, (dialogInterface, i) -> {
                    ...
                    Folders.renameFileOrFolder(list.get(selectedPosition).getFile(), string,
                            sdCardListViewAdapter, showHidden);
            ...
            case R.id.hide:
                if(list.get(selectedPosition).getFile().getName().startsWith("."))
                    ...
                    Folders.renameFileOrFolder(list.get(selectedPosition).getFile(),
                            "." + list.get(selectedPosition).getFile().getName(), sdCardListViewAdapter, showHidden);
                    Folders.sort(sort, isReverse, list, this);
                }
                break;
            case R.id.share:
